-- Script SQL para dados de exemplo em ambiente de desenvolvimento
...
-- Tarefas do E-commerce Platform (ID 1)
...
-- Tarefas da Migração Legacy (ID 2)
...
-- Tarefas do Sistema de Relatórios (ID 4)
